...
//-------------------------------------------------------------------------------------
// Default BRDF to use:
#if !defined (UNITY_BRDF_PBS_EX) // allow to explicitly override BRDF in custom shader
...
#define UNITY_BRDF_PBS_EX BRDF3_Unity_PBS
#elif defined(UNITY_PBS_USE_BRDF3)
#define UNITY_BRDF_PBS_EX BRDF3_Unity_PBS
#elif defined(UNITY_PBS_USE_BRDF2)
#define UNITY_BRDF_PBS_EX BRDF2_Unity_PBS
#elif defined(UNITY_PBS_USE_BRDF1)
#define UNITY_BRDF_PBS_EX BRDF1_Unity_PBS
#else
#define UNITY_BRDF_PBS_EX BRDF2_Unity_PBS
#endif
#endif
