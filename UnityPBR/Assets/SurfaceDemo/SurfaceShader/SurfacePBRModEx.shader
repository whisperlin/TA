...
Shader "SurfacePBR Mod Ex"
{
	...
	SubShader
	{
		...
		{
			s.GIData = data;
			LightingStandard_GI((SurfaceOutputStandard)s, data, gi);
		}
		...
		#pragma surface surf StandardCustomLighting   keepalpha  fullforwardshadows  nodynlightmap nodirlightmap nofog noforwardadd
