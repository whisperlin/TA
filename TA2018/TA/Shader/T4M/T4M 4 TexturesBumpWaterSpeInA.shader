...
Shader "TA/T4MShaders/ShaderModel3/Diffuse/T4M 4 Textures Bump Spe In A" 
{
	Properties
	{
		...
		[KeywordEnum(Off, On)] _IsMetallic("是否开启金属度", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "T4M 4 TexturesBumpWaterSpeInA.cginc"
			ENDCG
		}
