...
public class ExponentialHeightFogCtrl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Shader.SetGlobalVector("ExponentialFogParameters", ExponentialFogParameters);
        Shader.SetGlobalVector("ExponentialFogParameters2", ExponentialFogParameters2);
        Shader.SetGlobalVector("ExponentialFogParameters3", ExponentialFogParameters3);
        Shader.SetGlobalVector("DirectionalInscatteringColor", DirectionalInscatteringColor);
        Shader.SetGlobalVector("InscatteringLightDirection", InscatteringLightDirection);
        Shader.SetGlobalVector("ExponentialFogColorParameter", ExponentialFogColorParameter);
        Shader.SetGlobalColor("fogInscatteringColor2", fogInscatteringColor2);
