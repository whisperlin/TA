...
Shader "TA/T4M/T4M 4 Texture bump Sp" {
    Properties {
...
///////// Gloss:
                ...
                float gloss = (_Glossiness*((((_Splat0_var.a*_Control_var.r)+(_Splat1_var.a*_Control_var.g))+(_Splat2_var.a*_Control_var.b))+(_Splat3_var.a*_Control_var.a)));
...
////// Specular:
                ...
                float3 diffuseColor = ((((_Splat0_var.rgb*_Control_var.r)+(_Splat1_var.rgb*_Control_var.g))+(_Splat2_var.rgb*_Control_var.b))+(_Splat3_var.rgb*_Control_var.a)); // Need this for specular when using metallic
                diffuseColor = DiffuseAndSpecularFromMetallic( diffuseColor, specularColor, specularColor, specularMonochrome );

#if _ISWEATHER_ON
#if RAIN_ENABLE 

				calc_weather_info(i.posWorld.xyz, normalDirection, normalDirection, diffuseColor, normalDirection, diffuseColor.rgb);
#endif
#if SNOW_ENABLE 
