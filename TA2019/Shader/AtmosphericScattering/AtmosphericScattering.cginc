...
void RayLeight(float3 kSkyTintInGammaSpace,half _AtmosphereThickness, float3 eyeRay , inout half3 cIn, inout half3 cOut)
{
	float far = 0.0;
...
half getMiePhase(half eyeCos, half eyeCos2,half _SunSize)
{
