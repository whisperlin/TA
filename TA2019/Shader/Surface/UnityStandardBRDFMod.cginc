//-------------------------------------------------------------------------------------
		// Default BRDF to use:
#if !defined (UNITY_BRDF_PBS_MOD) // allow to explicitly override BRDF in custom shader
...
#define UNITY_BRDF_PBS_MOD BRDF3_Unity_PBS_MOD
#elif defined(UNITY_PBS_USE_BRDF3)
#define UNITY_BRDF_PBS_MOD BRDF3_Unity_PBS_MOD
#elif defined(UNITY_PBS_USE_BRDF2)
#define UNITY_BRDF_PBS_MOD BRDF2_Unity_PBS_MOD
#elif defined(UNITY_PBS_USE_BRDF1)
#define UNITY_BRDF_PBS_MOD BRDF1_Unity_PBS_MOD
#else
...
inline half4 LightingStandardExGI(SurfaceOutputStandard s, half3 viewDir, UnityGI gi)
{
	...
	half4 c = UNITY_BRDF_PBS_MOD(s.Albedo, specColor, oneMinusReflectivity, s.Smoothness, s.Normal, viewDir, gi.light, gi.indirect);
	c.a = outputAlpha;
	return c;
}

inline void LightingStandardExGI_GI(
