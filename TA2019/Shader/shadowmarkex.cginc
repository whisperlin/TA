...
#define __SHADOW_MARK_EX____ 1
	...
	*/
	...
	#else
		#if UNITY_SHADOW
			#define SHADOW_UVS(id0,id1) LIGHTING_COORDS(##id0, ##id1)  
		#else
...
#if UNITY_SHADOW
#define GET_SHADOW_ATTENUATION  float attenuation = LIGHT_ATTENUATION(i);
#else
...
#else
#define RETURN_LIGHT_MAP return lightmap;
#endif
