...
Shader "TA/Substance PBR  Perview" {
	Properties{
		...
		//_BakedingMatePower("烘培金属间接光照强度", Range(0, 1)) = 1
		...
		SubShader{
			...
			#pragma target 3.0
			#include "../Shader/unity_pbr-baked.cginc" 
			ENDCG
			}
